...
namespace PROJETOBEEP
{
    static class Tetris
    {
        ...
        static void Main()
        {
            ...
            {
                //Atualizamos a valor da variavel "daVerify" com o hora e minutos atuais
                dateVerify = DateTime.Now.ToString("HH:mm");
            }

            //seta o tempo incremento entre as execuções
            var startTimerIcrement = 200;

            //Pega um valor de um objeto qualquer e cria uma lista para o mesmo executando de acordo com a chamada
            switch (fileira)
            {
                //Case identifica que ele precisa fazer uma escolha
                //logo em seguida ele pede o numero escolhido *utilizado para menus.
                case "1": { Fileira1(startTimerIcrement); } break; //Executa a chamada de acordo com o número escolhido
                case "2": { Fileira2(startTimerIcrement); } break; //break finaliza a operação
                ...
                //EM CASO DE INFORMAR UMA STRING INVALIDA PARA O MENU O "DEFAULT" EXECUTA UMA AÇÃO.
